...
// import { registerOAuthRoutes } from "./oauth"; // Desabilitado para autenticação local
...
async function startServer() {
  ...
  // registerOAuthRoutes(app); // Desabilitado para autenticação local
  // tRPC API
  app.use(
    "/api/trpc",
  ...
  app.post("/api/scheduled/send-reminders", async (req, res) => {
    try {
      ...
      console.error("[Lembretes] Falha no callback agendado:", error);
